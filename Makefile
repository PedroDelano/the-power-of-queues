build-infrastructure:
	...
	uv run celery -A src.celery_app:app worker -P gevent -Q fast_io -c 10 -l INFO
	uv run celery -A src.celery_app:app worker -P preforked -Q cpu_bottleneck -c 1 -l INFO
